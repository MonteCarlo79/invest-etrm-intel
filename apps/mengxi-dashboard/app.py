...
# ---------------------------------------------------------------------------
with tab_portfolio:
    sub_pnl, sub_daily, sub_strategy, sub_avail, sub_registry = st.tabs([
        "P&L Waterfall",
        "Daily Ops",
        "Strategy Comparison",
        "Availability",
    ...
    with sub_registry:
        from libs.decision_models.adapters.app.registry_page import render_registry_page
...
# ---------------------------------------------------------------------------
# Tab 9: Nodal Maps — per-province PF spread ranking (precomputed daily)
# ---------------------------------------------------------------------------
with tab_nodal_maps:
    from nodal_maps_tab import render as _render_nodal_maps
    _render_nodal_maps(_get_sqlalchemy_engine)
...
# ---------------------------------------------------------------------------
# Tab 11: Nodal Analysis — BESS zones, price explorer, congestion clusters
# ---------------------------------------------------------------------------
