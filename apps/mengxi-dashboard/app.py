...
with tab_nodal_analysis:
    ...
    from services.mengxi_nodal.zones import CURRENT_ASSETS as _NA_ASSETS, UPCOMING_ASSETS as _NA_UPCOMING, ZONES as _NA_ZONES
    ...
    import numpy as _na_np

    _na_engine = _get_sqlalchemy_engine()
    ...
    if _na_start > _na_end:
        ...
        if not _na_av:
            ...
            def _na_parent_vec(day):
                ...
                if not mats:
                    return None
                return _na_np.nanmean(_na_np.stack(mats), axis=0)
