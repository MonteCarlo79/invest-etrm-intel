...
ASSET_PHYSICAL_PARAMS: dict = {
    # 蒙西 operator rule (per user 2026-09-02): system operator restricts BESS to
    # max 1.5 cycles/day per asset — applied to ALL Mengxi assets in PF LP.
    "suyou":       {"power_mw": 100.0, "duration_h": 4.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "wulate":      {"power_mw": 100.0, "duration_h": 2.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "wuhai":       {"power_mw": 100.0, "duration_h": 2.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "wulanchabu":  {"power_mw": 100.0, "duration_h": 2.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "hetao":       {"power_mw": 100.0, "duration_h": 2.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "hangjinqi":   {"power_mw": 100.0, "duration_h": 4.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "siziwangqi":  {"power_mw": 100.0, "duration_h": 4.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
    "gushanliang": {"power_mw": 500.0, "duration_h": 4.0, "roundtrip_eff": 0.85, "max_cycles_per_day": 1.5},
}
