...
|---------|-------|----------|----------|------------|---------------|
| Spot Market (Pillar 1) | Strategist | `bess-spot-markets` | `/spot-markets/*` | 8505 | v45 (td:144) |
...
| GB Market | Strategist + Quant | `bess-gb-market` | `/gb-market/*` | 8508 | v106 (td:29). Task-def family is `bess-gb-market` — `bess-platform-gb-market` is a DEAD family; never register against it. Live family not in terraform → deploys bypass terraform: jq-swap from the service's current tdArn |
