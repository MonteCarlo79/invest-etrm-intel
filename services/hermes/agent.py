...
- If the message is exactly or nearly "继续", "请继续", "continue", "go on", "接着说", "continue please" (with no other content), ALWAYS use REPLY and continue the previous assistant response exactly from where it was cut off — do NOT call MARKET_AGENT or re-fetch any data. Just resume the text.
