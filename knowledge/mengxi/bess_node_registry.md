...
|---|---|---|---|---|---|---|
| suyou | 景蓝乌尔图储能电站 | | 当前母站待定 (锡西二站未建成) | 220 | 内蒙.景蓝乌尔图储能电站/220kV.1M | 价格聚类指向二连/苏尼特区域 (苏尼特站/玉龙站/涌泉站) |
...
- **suyou (苏右)** — 锡西二站未建成 (2025-02 投运早于该站): "苏右旗100万储能项目接入系统评审意见.pdf" 实为 upcoming 锡西二项目(1000MW, 位于苏尼特右旗)的评审文件, 并非本资产接入凭证. 当前母站待定 — 价格聚类与2025-12-22主接线图均指向二连/苏尼特区域 (同区BESS: 蒙能百利格/大航都林/星能乌勒吉/蒙能亿力齐等). 运营数据自 2025-02-12.
...
- **二连/苏尼特 zone**: suyou 在运 (母站待定) + xixier (upcoming, 锡西二站在建) — 投运后同区.
...
| 二连/苏尼特 | **景蓝乌尔图**✓, 蒙能百利格✓, 大航都林✓, 星能乌勒吉✓, 蒙能亿力齐1/2站, 蒙能亿和1/2号, 明阳浩来图, 蒙能呼其, 蒙能吉博尔#1,2, 蒙能卓拉#1,2 + wind/PV: 伊林一场/二场, 二连协合, 二连恩和, 蒙科敖都, 天宏阳光, 乌日根, 中海油二连, 宏晖二连微网 |
